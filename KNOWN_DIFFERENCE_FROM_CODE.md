...
- Godot Watch Race exists as a presentation window over the same D-033 clock; the thin Career Hub is the main Godot scene and is not a KPI dashboard or a fun-gate result;
