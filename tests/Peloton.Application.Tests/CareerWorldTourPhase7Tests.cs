...
public sealed class CareerWorldTourPhase7Tests
{
    ...
    [Fact]
    public void SchemaVersionNineRoundTripsNegotiationWorldAndChecksum()
    {
        ...
        Assert.Equal("11", SqliteWorldSaveStore.SchemaVersion.ToString(System.Globalization.CultureInfo.InvariantCulture));
