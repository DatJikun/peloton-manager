...
- `2026-08-28` — Właściciel pokazał mockup RACE LIVE. Godot układa żywy ekran tak samo (profil, zawodnicy, lider, różnice czasowe, pasek komunikatów). Pola, których prototyp nie ma (pogoda, waty, komentator, zdjęcie), zostają puste — nie dopisujemy ich.
