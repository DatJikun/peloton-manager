...
- `2026-08-27` — Avatar prototype: oczy otwarte w pionie (`th` 12.0–14.6 / `bh` 10.2–12.4), szerokość bez zmian; affine nie spłaszcza już `scale_y`. Pakiet `0.9.0-placeholder`. Styl `poster` bez zmian.
