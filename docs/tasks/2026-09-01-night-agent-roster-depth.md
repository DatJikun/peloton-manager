...
## Nie robić
Zmieniać istniejących 200 wpisów liczbowo; ruszać silnik, assembler, schema, Godot; dodawać kluby; „kocie łby” (po polsku **bruk**); fabrykować statystyki mocy jako „prawdziwe” (to pasma estimated — D-038); przekraczać 512.
