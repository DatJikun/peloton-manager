...
**Authority:** D-018, D-022, D-042, D-045, D-046, `RACE_ENGINE_DESIGN_v0.2.md` R-003 / §§30–33  
...
- **D-045** — Player-facing ratings are derived from physiology. Physiology remains the race cause.
- **D-046** — Detailed course profiles + identity-constrained yearly generator. Defaults persist in the world. Not a five-fragment mock.
