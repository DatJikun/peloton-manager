...
| Godot career shell | `Peloton.Client.Godot/CareerShellHost.cs`, `CareerShellScreen.cs`, `CareerShellViews.cs` | MainMenu club picker → pre-season plan → management; `ClubRosterProjection` on desk/squad; world calendar | `CareerShellHostTests` |
